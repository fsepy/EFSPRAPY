...
from ..cfast.cfast import calculate_hrr_and_smoke_with_sprinkler_suppression_cfast
...
def main(
    ...
    return np.average(q_inc), t_ig_ftp, ftp[-1], t_ig_safir, t_max_safir, T_max_safir, t_d,
